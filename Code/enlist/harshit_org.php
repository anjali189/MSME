...
<body>
	...
	<div class='wrapper' style="margin-top: 50px;">
		...
		<div id="first">
			<form action="harshit_php.php" method="POST">
				<input style="margin-top: 20px;" type="text" name="udyog_aadhaar" placeholder="Udyog Aadhaar Number" value="<?php
				if(isset($_SESSION['udyog_aadhaar'])){
					echo $_SESSION['udyog_aadhaar'];
				}
				?>" required />
				<br/>
				...
				<br/>
				<a href='register.php' id='signup' class="signup">Need and account? Register here<br/></a>
				<?php if(in_array("Udyog Aadhaar was incorrect<br/>", $error_array)) echo "Udyog Aadhaar was incorrect<br/>"; ?>
			</form>
		</div>
