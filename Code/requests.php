...
<div class='main_column column' id="main_column">
	...
	$query = mysqli_query($con, "SELECT * FROM follow_requests WHERE user_to='$userLoggedIn'");
	if(mysqli_num_rows($query) == 0){
		...
		while($row = mysqli_fetch_array($query)){
			...
			if(isset($_POST['accept_request'.$user_from])){
				...
				$delete_query = mysqli_query($con, "DELETE FROM follow_requests WHERE user_to='$userLoggedIn' AND user_from='$user_from'");
				echo "You Started Following!";
