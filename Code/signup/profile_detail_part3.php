                        ...
                        <li class="nav-item">
                          <div class="dropdown" style="float:right;margin-top:9px; margin-left:2px;">
                            ...
                            <div class="dropdown-content">
                              <a  class="nav-link" href="signup/employ_signup_step1.php">Employ</a>
                ...
                <div class="mx-auto col-sm-6">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="mb-0">Profile Detail</h4>
                                </div>
                                <div class="card-body">
                                    <form class="form" role="form" autocomplete="off">
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input class="form-control" id="f_name"type="text" value="">
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-lg-9">
                                                    <input class="form-control" id="l_name" type="text" value="">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label form-control-label">Email</label>
                                                <div class="col-lg-9">
                                                    <input id="email-input" class="form-control"  type="email" value="">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label form-control-label">Mobile Number</label>
                                                 <div class="col-lg-9">
                                                     <input id="e_designation" class="form-control" type="text" value="">
                                                 </div>
                                             </div>
                                         <div class="form-group row">
                                           <label class="col-lg-3 col-form-label form-control-label">MSME Enterprise</label>
                                            <div class="col-lg-9">
                                                <input id="organization2" class="form-control" type="text" value="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                         ...
                                         <div class="form-group row">
                                            ...
                                            <div class="col-lg-9">
                                                <input id="password" class="form-control" type="password" required value="">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-3 col-form-label form-control-label"></label>
                                            <div class="col-lg-9 text-center">
                                            <input type="button" id ="submit" class="btn btn-primary" value="Submit"> <style> #submit.btn-primary{background-color: #28a745!important}</style>
                                            </div>
                                        </div>
                                    </form>
                                </div>
