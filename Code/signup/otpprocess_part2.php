        ...
        <div class="row">
            <div class="mx-auto col-sm-6">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                            <form  action="../otp/otpprocess.php" method="post">
                                    
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label form-control-label">Mobile Number</label>
                                        <div class="col-lg-9">
                                            <input class="form-control"  type="text" name="otpvalue" maxlength="10"  >
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9 text-center">
                                            ...
                                            <input type="button" id ="submit" class="btn btn-primary" value="Verify Authentication Pin" style="text-align:center;">
