...
class User {
	...
	public function getNumberOfFriendRequests(){
		...
		$query = mysqli_query($this->con, "SELECT * FROM follow_requests WHERE user_to='$username'");
	...
	public function didReceiveRequest($user_from){
		...
		$check_request_query = mysqli_query($this->con, "SELECT * FROM follow_requests WHERE user_to='$user_to' AND user_from='$user_from'");
	...
	public function SendRequest($user_to){
		$user_from = $this->user['username'];
		$query = mysqli_query($this->con, "INSERT INTO follow_requests VALUES(NULL, '$user_to', '$user_from')");
	}
